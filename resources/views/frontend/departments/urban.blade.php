...
@section('title', 'Urban Development')
@section('meta_description', 'The Urban Development department of Elwak Municipality — planning, infrastructure, roads, and urban growth management.')
@section('meta_keywords', 'Elwak, Municipality, Urban, Development, planning, infrastructure, Mandera')
...
<main class="main">
    ...
    <!-- Page Title -->
    <div class="page-title dark-background" data-aos="fade" style="background-image: url({{asset('assets/img/slider/urban.jpeg')}});">
    ...
    <section id="aboutundefined-5" class="aboutundefined-5 section">
      ...
      <div class="container">
        ...
        <div class="row gy-4" data-aos="fade-up" data-aos-delay="100">
          <div class="col-lg-5">
            <img src="{{asset('assets/img/slider/mk.jpg')}}" class="img-fluid" alt="Urban Development - Elwak Municipality" loading="lazy">
          </div>
    ...
    @foreach($dept as $key => $row)
      <div class="swiper-slide">
        <div class="testimonial-item">
          <img src="{{ Storage::url($row->photo) }}" class="testimonial-img" alt="Urban Development team member" loading="lazy">
          <h3>{{$row->hod}}</h3>
